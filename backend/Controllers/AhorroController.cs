    ...
    public class AhorroController : ControllerBase
    {
        ...
        public async Task<ActionResult<Ahorro>> CreateAhorro(CrearAhorroDTO ahorroDto)
        {
            try
            {
                var ahorro = new Ahorro
                {
                    ...
                    FechaInicio = DateTime.UtcNow,  // Ya está en UTC
                    FechaObjetivo = ahorroDto.FechaObjetivo.HasValue
                        ? DateTime.SpecifyKind(ahorroDto.FechaObjetivo.Value, DateTimeKind.Utc)
                        : null,  // Convertir a UTC si tiene valor
        ...
        public async Task<IActionResult> UpdateAhorro(int id, CrearAhorroDTO ahorroDto)
        {
            try
            {
                ...
                ahorro.FechaObjetivo = ahorroDto.FechaObjetivo.HasValue
                    ? DateTime.SpecifyKind(ahorroDto.FechaObjetivo.Value, DateTimeKind.Utc)
                    : null;
